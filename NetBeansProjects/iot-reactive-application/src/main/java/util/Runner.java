...
public class Runner {
  ...
  private static final String IOT_REACTIVE_JAVA_DIR =  "/src/main/java/br/ufba/dcc/wiser/iot_reactive";

      
      
  public static void runExample(Class clazz) {
    runExample(IOT_REACTIVE_JAVA_DIR, clazz, new VertxOptions().setClustered(false), null);
  }

  public static void runExample(Class clazz, DeploymentOptions options) {
    runExample(IOT_REACTIVE_JAVA_DIR, clazz, new VertxOptions().setClustered(false), options);
  }
